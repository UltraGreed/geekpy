...
(
  ...
  python3 object.py    -5  5 BallR  0.10   0.25 0.99  1.0 &
  python3 object.py    -6  6 BallY  0.10   0.25 0.99  1.0 &
  python3 object.py    -7  5 BallG  0.10   0.25 0.99  1.0 &
  python3 object.py   -10 12 CellR  0.10   0.25 0.99  1.0 &
  python3 object.py   -10 11 CellY  0.10   0.25 0.99  1.0 &
  python3 object.py   -10 10 CellB  0.10   0.25 0.99  1.0 &
  # python3 object.py    -3 11 Frame  0.50   1.00 1.00  90.0 &
  # SoundDelay simulation:
  python3 acoustic.py -9.5 10.5 2.0      0.01 30000 1.00  90.0 &
