...
P   = [  0.50,   0.50,   0.50,   3.00,   3.00,   1.00]  # Proportional coefficients of regulator.
D   = [  1.00,   1.00,   0.50,   3.00,   3.00,   1.00]  # Differential coefficients of regulator.
MAX = [  0.10,   0.05,   1.00,  90.00,  90.00,  90.00]  # Maximal possible velocity in stabilization mode.
MIN = [ -0.05,  -0.05,  -1.00, -90.00, -90.00, -90.00]  # Minimal possible velocity in stabilization mode.
