    ...
    def __init__(self, objs=None):
        if objs is None:
            objs = {  #### X,    Y, DEPTH,   YAW, PITCH, ROLL,    COLOR     DIAMETER
                ...
                # "Aruco": [15.0, 5, 1.2, 0.0, 0.0, 0.0, "#FF5733"],
                # "SquareGreen": [7.0, 7, 2, 0.0, 0.0, 0.0, "#38761D"],
                # "SquareOrange": [0.0, 0, 2, 0.0, 0.0, 0.0, "#FFDB00"],
                # "SquareBlack": [7.0, 7, 2, 0.0, 0.0, 0.0, "#000000"],
                # "Boxes": [3, 2.6, 2, 77.0, 0.0, 0.0, "#F44336"],
                "Line": [0, 1, 1, 0.0, 0.0, 0.0, "#000000"],
                # "Pinger": [0, 0, 2, 0, 0, 0, "#0000ff"]
                "CircleRed": [0, 0, 1, 0.0, 0.0, 0.0, "#ff0000"],
                "TriangleGreen" : [0, 0, 1, 0.0, 0.0, 0.0, "#00ff00"],
                "SquareYellow" : [0, 0, 1, 0.0, 0.0, 0.0, "#ffff00"],
                "Target": [0, 3, 0.5, 0.0, 0.0, 0.0, "#999999"],
            }
        self.objs = objs
