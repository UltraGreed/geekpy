    ...
    def __init__(self, objs=None):
        if objs is None:
            objs = {     #### X,    Y, DEPTH,   YAW, PITCH, ROLL, COLOR
                ...
                "BallR": [ -5.0,  5.0,   2.0,   0.0,   0.0,  0.0, "#EE000099"],
                "BallY": [ -6.0,  6.0,   2.0,   0.0,   0.0,  0.0, "#EEEE0099"],
                "BallG": [ -7.0,  5.0,   2.0,   0.0,   0.0,  0.0, "#00EE0099"],
                "CellB": [-10.0, 10.5,   1.25,  0.0,   0.0,  0.0, "#0000AA99"],
                "CellY": [-10.0, 11.0,   1.25,  0.0,   0.0,  0.0, "#AAAA0099"],
                "CellR": [-10.0, 11.5,   1.25,  0.0,   0.0,  0.0, "#AA000099"],
                "Cells": [-10.0, 10.0,   1.25,  0.0,   0.0,  0.0, "#00CCCC99"],
                "Frame": [ -6.5, 12.0,   1.25,  0.0,   0.0,  0.0, "#CC00CC99"],
            }
        self.objs = objs
