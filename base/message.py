    ...
    def __init__(self, objs=None):
        if objs is None:
            objs = {  #### X,    Y, DEPTH,   YAW, PITCH, ROLL,    COLOR     DIAMETER
                ...
                "SquareGreen": [7.0, 7, 1.2, 0.0, 0.0, 0.0, "#38761D"],
                "SquareYellow": [0.0, 0, 1.2, 0.0, 0.0, 0.0, "#FFDB00"],
                "SquareBlack": [7.0, 7, 1.2, 0.0, 0.0, 0.0, "#000000"],
                "Boxes": [3, 2.6, 1.0, 77.0, 0.0, 0.0, "#F44336"],
                "Line": [0, 1, 1.2, 0.0, 0.0, 0.0, "#000000"],
