...
loop(roll=1000000, dt=1.75)
stab(origin='Cuurent', yaw=0.0, dt=3.0, depth=0.9)
loop(roll=1000000, dt=1.75)
...
stab(origin='Frame', yaw=136.0, dt=5.0, depth=0.5)

# print('get back')
# tack(origin='Navigation', yaw=-180.0, speed=0.6, dist=3.0, depth=0.5)

tack(origin='Navigation', yaw=137.0, speed=0.6, dist=7.0, depth=0.6)
stab(origin='Current', yaw=-180.0, depth=0.6)
tack(origin='Current', yaw=0.0, speed=0.6, dist=1.5, depth=0.6)
stab(origin='Current', yaw=-180.0, depth=0.6)
tack(origin='Current', yaw=0.0, speed=0.6, dist=1.5, depth=0.6)
stab(origin='Current', yaw=-180.0, depth=0.6)
tack(origin='Current', yaw=0.0, speed=0.6, dist=1.5, depth=0.6)
