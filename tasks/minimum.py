...
print('gate')
tack(origin='Current', yaw=0.0, dist=1.0, speed=0.7, depth=0.7)
tack(origin='Navigation', dist=1.0, speed=0.0, yaw=270.0, dt=3.0, depth=0.7)
tack(origin='Navigation', dist=1.0, speed=0.0, yaw=180.0, dt=3.0, depth=0.7)
tack(origin='Navigation', dist=1.0, speed=0.0, yaw=90.0, dt=3.0, depth=0.7)
tack(origin='Navigation', dist=1.0, speed=0.0, yaw=1.0, dt=3.0, depth=0.7)
tack(origin='Navigation', dist=1.0, speed=0.0, yaw=270.0, dt=3.0, depth=0.7)
tack(origin='Navigation', dist=1.0, speed=0.0, yaw=180.0, dt=3.0, depth=0.7)
tack(origin='Navigation', dist=1.0, speed=0.0, yaw=90.0, dt=3.0, depth=0.7)
tack(origin='Navigation', dist=1.0, speed=0.0, yaw=1.0, dt=3.0, depth=0.7)
