...
tack(mode='Absolute', yaw=0.0, dist=1.0, speed=0.1, depth=0.5, dt=1)
tack(mode='Absolute', yaw=30, dist=1.0, speed=0.0, depth=0.5, dt=2)
tack(mode='Absolute', yaw=-30, dist=1.0, speed=0.0, depth=0.5, dt=2)
tack(mode='Absolute', yaw=0.0, dist=1.0, speed=-0.2, depth=0)
