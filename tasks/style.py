...
print('gate')
tack(mode='Relative', yaw=0.0, dist=2.0, speed=0.7, depth=1.1)
loop(roll=1000000, dt=3.5)
tack(mode='Absolute', yaw=1.0, dist=0.75, speed=0.7, depth=0.7)
tack(mode='Absolute', yaw=-95.0, dist=15.0, speed=0.7, depth=0.4)
...
tack(mode='Absolute', yaw=CORRECTION, dist=1.2, speed=0.4, dt=4.0, depth=0.5)

print('drop')
detection.on(obj='CellY', timeout=10.0)
tack(mode='Absolute', yaw=CORRECTION, dist=1.0, speed=0.4, dt=4.0, depth=0.5)
...
tack(mode='Relative', dist=1.0, speed=0.0, yaw=0.0, dt=3.0, depth=1.1)
detection.off(obj='CellY', timeout=100.0)

print('frame')
detection.on(obj='Frame', timeout=10.0)
tack(mode='Relative', dist=1.0, speed=0.0, yaw=0.0, dt=5.0, depth=0.5)
...
print('get back')
tack(mode='Absolute', yaw=-180.0, speed=0.6, dist=3.0, depth=0.5)
