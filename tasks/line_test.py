...
Net().send(InitRobot(yaw=0, depth=0, x=-9, y=0))
...
line_movement(0.2, 3, depth=0.0, timeout=90)

stab(origin="Aruco", yaw=None, dt=6, depth=0.0)
stab(origin="Aruco", yaw="Object", dt=6, depth=0.0)
stab(origin="Aruco", yaw="Object", dt=15, depth=0.9)
