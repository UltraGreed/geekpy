...
while True:
    ...
    elif ch == "1": net.send(message.Tack(time=1, stab_yaw=  0.0))
    elif ch == "2": net.send(message.Tack(time=1, stab_yaw= 45.0))
    elif ch == "3": net.send(message.Tack(time=1, stab_yaw= 90.0))
    elif ch == "4": net.send(message.Tack(time=1, stab_yaw=135.0))
    elif ch == "5": net.send(message.Tack(time=1, stab_yaw=180.0))
    elif ch == "6": net.send(message.Tack(time=1, stab_yaw=225.0))
    elif ch == "7": net.send(message.Tack(time=1, stab_yaw=270.0))
    elif ch == "8": net.send(message.Tack(time=1, stab_yaw=315.0))
    elif ch == "9": net.send(message.Tack(time=1, stab_yaw=360.0))

    elif ch == "f": net.send(message.Tack(time=1, stab_x=-2))
    elif ch == "h": net.send(message.Tack(time=1, stab_x= 2))
