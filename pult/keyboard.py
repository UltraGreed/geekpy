...
while True:
    ...
    elif ch == "f": net.send(message.Tack(time=5, stab_x=-1))
    elif ch == "h": net.send(message.Tack(time=5, stab_x= 1))
    elif ch == "g": net.send(message.Tack(time=5, stab_y=-1))
    elif ch == "t": net.send(message.Tack(time=5, stab_y= 1))

    elif ch == "i": net.send(message.Tack(time=5, stab_x=-1, stab_y= 1))
    elif ch == "o": net.send(message.Tack(time=5, stab_x= 1, stab_y= 1))
    elif ch == "k": net.send(message.Tack(time=5, stab_x=-1, stab_y=-1))
    elif ch == "l": net.send(message.Tack(time=5, stab_x= 1, stab_y=-1))
